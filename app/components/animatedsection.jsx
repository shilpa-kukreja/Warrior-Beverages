...
//         <div className="relative w-full max-w-[1450px] h-[700px] md:h-[700px] h-[520px] mx-auto">
//           {/* Orbit Track */}
//           <div
//             ref={trackRef}
...
//       const controlX = trackRect.width / 2;
//       const bottleTopRelative = bottleRect.top - trackRect.top;
//       const controlY = (4 * bottleTopRelative - startY - endY) / 2;
...
//   return (
//     <div className="relative w-full h-[100dvh] sm:min-h-screen overflow-hidden">
//       {/* Background Image */}
//       <div className="absolute inset-0">
//         <Image
//           src="/animated/1.jpg"
...
//       {/* Main content - centered on mobile, bottom-aligned on desktop */}
//       <div className="absolute inset-0 flex items-center sm:items-end justify-center pb-[2%] sm:pb-[5%]">
//         <div className="relative w-full max-w-[1450px] h-[420px] sm:h-[500px] md:h-[700px] mx-auto">
//           {/* Orbit track (logos container) */}
...
//                   <div className="relative w-[65px] h-[65px] sm:w-[85px] sm:h-[85px] md:w-[120px] md:h-[120px]">
//                     <div className="absolute inset-0 bg-white/90 backdrop-blur-md rounded-xl md:rounded-2xl shadow-lg border border-white/30 transition-all duration-300 group-hover:bg-white/98 group-hover:shadow-xl group-hover:scale-105" />
//                     <Image
//                       src={src}
//                       alt="brand logo"
//                       fill
//                       className="object-contain p-2 transition-transform duration-300 group-hover:scale-105"
//                       sizes="(max-width: 640px) 65px, (max-width: 768px) 85px, 120px"
//                     />
//                   </div>
//                 </div>
//               </div>
...
//           {/* Center bottle - positioned higher on mobile */}
//           <div
//             ref={bottleRef}
//             className="absolute left-1/2 top-[52%] sm:top-[58%] md:top-[72%] -translate-x-1/2 -translate-y-1/2 z-30 flex flex-col items-center"
//           >
//             <img
//               key={bottleIndex}
//               src={bottleImages[bottleIndex]}
//               alt="premium bottle"
//               className="h-[340px] sm:h-[380px] md:h-[560px] w-auto object-contain transition-all duration-700 ease-out drop-shadow-[0_25px_70px_rgba(0,0,0,0.6)]"
//             />
//             {/* Subtle glow behind bottle */}
//             <div className="absolute inset-0 -z-10 bg-[radial-gradient(ellipse_at_center,rgba(255,255,255,0.15)_0%,transparent_70%)] blur-2xl" />
//           </div>
//         </div>
//       </div>
//     </div>
...
export default function AnimatedSection() {
  ...
  return (
    // Removed overflow-hidden from the outer container to prevent clipping of logos
    <div className="relative w-full h-[100dvh] sm:min-h-screen">
      {/* Background Image – wrapped in a container with overflow-hidden to keep it clipped */}
