        ...
        <div className="mx-auto max-w-4xl px-6 py-12 md:px-8">
          ...
          >
            ...
            <div className="mt-8 space-y-6 text-gray-700">
              <section>
                <h2 className="text-2xl font-semibold text-[#861981]">1. Acceptance of Terms</h2>
              ...
              <section>
                <h2 className="text-2xl font-semibold text-[#861981]">2. Products & Pricing</h2>
                <p className="mt-2 leading-relaxed">
              ...
              <section>
                <h2 className="text-2xl font-semibold text-[#861981]">3. Orders & Payments</h2>
                <p className="mt-2 leading-relaxed">
              ...
              <section>
                <h2 className="text-2xl font-semibold text-[#861981]">4. Custom Branding & Intellectual Property</h2>
                <p className="mt-2 leading-relaxed">
              ...
              <section>
                <h2 className="text-2xl font-semibold text-[#861981]">5. Shipping & Delivery</h2>
                <p className="mt-2 leading-relaxed">
              ...
              <section>
                <h2 className="text-2xl font-semibold text-[#861981]">6. Returns & Refunds</h2>
                <p className="mt-2 leading-relaxed">
              ...
              <section>
                <h2 className="text-2xl font-semibold text-[#861981]">7. Limitation of Liability</h2>
                <p className="mt-2 leading-relaxed">
              ...
              <section>
                <h2 className="text-2xl font-semibold text-[#861981]">8. Governing Law</h2>
                <p className="mt-2 leading-relaxed">
              ...
              <section>
                <h2 className="text-2xl font-semibold text-[#861981]">9. Changes to Terms</h2>
                <p className="mt-2 leading-relaxed">
              ...
              <section>
                <h2 className="text-2xl font-semibold text-[#861981]">10. Contact Information</h2>
                <p className="mt-2 leading-relaxed">
                  For any questions regarding these Terms, please contact us at:<br />
                  Email: <a href="mailto:legal@warriorbev.com" className="text-[#861981] underline">legal@warriorbev.com</a><br />
