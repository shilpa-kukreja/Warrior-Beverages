...
export default function AboutPage() {
  ...
  // Team data
  const team = [
    { name: "Adarsh Raj Singh", role: "Founder & CEO", image: "/about/1.png", bio: "Adarsh Raj Singh is the Founder & CEO of Warrior Beverages Private Limited. With over 12 years of experience in SaaS and entrepreneurship, he brings a strong background in business development, technology, and brand building. He leads the vision behind Neysa, focused on creating a trusted and premium beverage brand for the Indian market." },
    { name: "Ranjit Bajaj ", role: "Strategic Mentor", image: "/about/2.png", bio: "Ranjit Bajaj serves as Strategic Mentor to Warrior Beverages Private Limited. An accomplished entrepreneur and business leader, he brings extensive experience in building organizations, developing brands, and driving growth. His strategic guidance and industry insights support Warrior Beverages in its journey to build Neysa into a trusted and nationally recognized beverage brand." },
    { name: "Raj Kumar Rathore", role: "Head of Operations", image: "/about/3.png", bio: "Raj Kumar Rathore serves as Head of Operations at Warrior Beverages Private Limited. With over 14 years of experience in retail and distribution, he brings deep expertise in supply chain management, market operations, and channel development. His operational leadership plays a key role in ensuring efficient execution and supporting the growth of Neysa Premium Water." },
  ];
