        ...
        <div className="mx-auto max-w-4xl px-6 py-12 md:px-8">
          ...
          >
            ...
            <div className="mt-8 space-y-6 text-gray-700">
              <section>
                <h2 className="text-2xl font-semibold text-[#861981]">1. Introduction</h2>
              ...
              <section>
                <h2 className="text-2xl font-semibold text-[#861981]">2. Information We Collect</h2>
              ...
              <section>
                <h2 className="text-2xl font-semibold text-[#861981]">3. How We Use Your Information</h2>
              ...
              <section>
                <h2 className="text-2xl font-semibold text-[#861981]">4. Sharing Your Information</h2>
                <p className="mt-2 leading-relaxed">
              ...
              <section>
                <h2 className="text-2xl font-semibold text-[#861981]">5. Data Security</h2>
                <p className="mt-2 leading-relaxed">
              ...
              <section>
                <h2 className="text-2xl font-semibold text-[#861981]">6. Your Rights</h2>
                <p className="mt-2 leading-relaxed">
                  You have the right to access, update, or delete your personal information. To exercise these rights, please contact us at <a href="mailto:privacy@warriorbev.com" className="text-[#861981] underline">privacy@warriorbev.com</a>.
                </p>
              </section>

              <section>
                <h2 className="text-2xl font-semibold text-[#861981]">7. Cookies</h2>
                <p className="mt-2 leading-relaxed">
              ...
              <section>
                <h2 className="text-2xl font-semibold text-[#861981]">8. Changes to This Policy</h2>
                <p className="mt-2 leading-relaxed">
              ...
              <section>
                <h2 className="text-2xl font-semibold text-[#861981]">9. Contact Us</h2>
                <p className="mt-2 leading-relaxed">
                  If you have any questions about this Privacy Policy, please contact us at:<br />
                  Email: <a href="mailto:support@warriorbev.com" className="text-[#861981] underline">support@warriorbev.com</a><br />
