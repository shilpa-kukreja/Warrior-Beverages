    ...
    <>
      ...
      <main className="min-h-screen bg-gradient-to-b from-slate-50 via-white to-slate-50">
        <div className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8 lg:py-24">
          ...
          >
            {/* <div className="inline-flex items-center gap-2 rounded-full bg-[#304869]/10 px-4 py-2 text-sm font-medium text-[#304869]">
            ...
            <p className="mx-auto mt-4 max-w-2xl text-lg text-gray-600 sm:text-xl">
              From our state-of-the-art facility to your doorstep — we deliver quality,
              consistency, and excellence across India.
            </p>
          </motion.div>
